...
function translateModel() {
	...
	self.articles = ["is", "am", "are", "was", "were", "be", "being", "been", "have", 
			"had", "having", "me", "he", "him", "she", "her", "it",
			"the", "this", "these", "those", "there", "their", "than", "then"];

	self.line = ko.observable('Insert text to translate here');
	...
	self.translateLine = function() {
		self.line("THERE IS NOTHING TO TRANSLATE HERE");
